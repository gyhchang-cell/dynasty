...
| 模组 | 版本 | 作用 | 许可 |
| --- | --- | --- | --- |
| **Dynasty 王朝**（本体） | 1.4.0 | 全部玩法：王朝、**4 个自建维度**（天朝 / 地府 / 九霄 / 龙宫）、科举、军队、神兽、**6 个 Boss**、任务/图鉴、**28 把兵器（毕业武器天子剑 1900）**、**17 套护甲**、9 种建筑、法阵召唤 Boss、**38 件饰品（开局 3 槽 → 满阶 8 槽）** | 本项目 |
| **Curios API** | 5.14.1+1.20.1 | **饰品槽位**：我们的 **27 件饰品**直接放进 Curios 的 charm / necklace / ring / belt / head / curio 槽 | LGPL-3.0 |
...
| **FTB Quests** | 2001.4.22 | **任务书**：**12 章 297 条**王朝任务（**前置图经环检测，0 处环**、**排布经自检**），**严格前置**；判定全部自动化：物品 / 击杀 / 维度 / 成就；奖励为物品 + 经验 + 功名 | 开源 |
...
> `选项 → 控制 → FTB Quests` 里确认/设置）。**12 章 297 条**，
> 左侧栏按 **3 组**分好类（可折叠，和「愚者 / 登神者」一个样子），
> **每章 = 1 个章首任务 + 2~4 条并行支线**（支线长度不一样，画面是分叉的树枝状），
> 多条线可以同时推进；章与章之间相连（章首 ← 上一章末尾）：
>
> | 分组 | 章节 | 条数 | 主题 |
> | --- | --- | --- | --- |
> | 王朝主线 | 一、初入王朝 | 23 | 木矛 → 铁剑 → 青铜、竹简徽墨、玉矿起步 |
> | 王朝主线 | 二、农桑百工 | 16 | 图纸与图鉴、庖厨、宫殿建材、符箓、丹药 5 条线 |
> | 王朝主线 | 三、朝堂科举 | 27 | 文房/藏书/官阶/印信/朝堂/登基/俸禄 7 条线，20 阶官阶 |
> | 王朝主线 | 四、军旅与平叛 | 18 | 征兵、平叛、内廷、帝陵、军械 5 条线 |
> | 王朝主线 | 五、神兽与帝王 | 13 | 麒麟、凤凰、年兽 + 牧场支线 |
> | 万里山河 | 六、天朝·龙庭 | 18 | 入境/龙晶/龙帝 + 营造·归途两条契机支线 |
> | 万里山河 | 七、地府幽冥 | 16 | 九尾狐、亡者 + 黄泉路、幽冥灯火两条契机支线 |
> | 万里山河 | 八、九霄天界 | 14 | 云兵、天将 + 云梯、雷池天马两条契机支线 |
> | 万里山河 | 九、东海龙宫 | 17 | 龙王、分水三叉戟 + 海底建材、寻宝两条契机支线 |
> | 神兵宝甲 | 十、兵器谱 | 33 | **28 把兵器九条线**：刀/剑/长柄/斧钺/**弓·速射**/**弓·穿透**/奇兵/御赐/里程碑 |
> | 神兵宝甲 | 十一、甲胄谱 | 64 | **17 套甲胄 × 4 件**，按「批次 × 部位」排成 8 条平行升级链 |
> | 神兵宝甲 | 十二、饰品图鉴 | 38 | **五类**：入门佩饰 / 通灵瑞兽 / 功名文房 / 战阵护身 / 传世至宝 |
>
...
> 每 4 阶 **多开 1 个饰品槽**（开局只有 **1 个背饰格**，满阶 6 格）。
...
> 饰品**只放 Curios 槽位**（模组内不再有自己的饰品界面）：项链 / 戒指 / 腰带 / 护符 / 头部 + 6 格「王朝饰品」槽，在物品栏旁边就能看到。
