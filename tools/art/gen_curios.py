...
GROUPS = {
    ...
    "necklace": "jade_pendant jade_bi_disc dragon_scale_charm qilin_horn_charm moon_pendant jade_marrow_charm alchemy_pendant fox_spirit_pendant imperial_pearl_earring "
                "noon_pendant eclipse_bead soul_candle_charm crimson_pact_charm bone_chill_pendant abyss_pearl throne_inheritance_charm",
    "ring": "phoenix_ring dragon_bone_ring jade_ring sun_chaser_ring starless_night_ring lifedrain_ring nether_binding_ring",
    "bracelet": "wrist_guard zen_bead_string guqin_string bow_string",
    "hands": "bear_paw tiger_claw folding_fan jade_ruyi drum_beater quickdraw_glove dawn_drum warlord_drum_charm",
    "body": "heart_mirror scale_plate iron_pauldron knee_guard cloud_brocade mandarin_rank_badge merit_badge scholar_ink_badge dragon_king_scale moonlit_mirror",
    "back": "arrow_quiver turtle_shell crane_feather sky_feather immortal_crane_feather phoenix_wing_charm war_banner_charm scroll_case_charm night_heron_feather",
